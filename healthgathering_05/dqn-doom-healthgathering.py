...
class Estimator():
	...
	#conv4 = tf.contrib.layers.conv2d(
        #    pool3, 64, 3, 1, activation_fn=tf.nn.relu, padding="VALID", scope="conv4")
        #pool4 = tf.nn.max_pool(conv2, [1, 3, 3, 1], [1, 2, 2, 1], padding='VALID')

        #conv5 = tf.contrib.layers.conv2d(
        #    pool4, 64, 2, 1, activation_fn=tf.nn.relu, padding="VALID", scope="conv4")
        #pool5 = tf.nn.max_pool(conv3, [1, 3, 3, 1], [1, 2, 2, 1], padding='VALID')
