...
def make_env():
    env_spec = gym.spec('ppaquette/DoomPredictPosition-v0')
    env_spec.id = 'DoomPredictPosition-v0'
    env = env_spec.make()
...
NOOP, SHOOT, TURN_R, TURN_L  = 0, 1, 2, 3
    ...
    for i_episode in range(num_episodes):
	    ...
	    env.render()
            ...
            if done:
                ...
                print('noop %d, shoot %d, turn_right %d, turn_left %d' % \
